...
public class Distributions {
  ...
  public static class Bernoulli implements Distribution {
    ...
    public static void validate(List<Double> params) throws CompilerException {
      if (params == null || params.size() != 1) {
        throw new CompilerException("Expected exactly one parameter (probability), for Bernoulli distribution");
      } else if (params.get(0) > 1) {
        throw new CompilerException(String
            .format("%s is not in valid range '0 <= probability <= 1', for Bernoulli distribution", params.get(0)));
      }
    }
  ...
  public static class Binomial implements Distribution {
    ...
    public static void validate(List<Double> params) throws CompilerException {
      if (params == null || params.size() != 2) {
        throw new CompilerException("Expected exactly two parameters (trials, probability), for Binomial distribution");
      } else if (params.get(1) > 1) {
        throw new CompilerException(String
            .format("%s is not in valid range '0 <= probability <= 1', for Binomial distribution", params.get(1)));
      }
    }
  ...
  public static class Exponential implements Distribution {
    ...
    public static void validate(List<Double> params) throws CompilerException {
      if (params == null || params.size() != 1) {
        throw new CompilerException("Expected exactly one parameter (lambda), for Exponential distribution");
      } else if (params.get(0) <= 0) {
        throw new CompilerException(
            String.format("%s is not in valid range 'lambda > 0', for Exponential distribution", params.get(0)));
      }
    }
  ...
  public static class Gamma implements Distribution {
    ...
    public static void validate(List<Double> params) throws CompilerException {
      if (params == null || params.size() != 2) {
        throw new CompilerException("Expected exactly two parameters (shape, scale), for Gamma distribution");
      } else if (params.get(0) <= 0) {
        throw new CompilerException(
            String.format("%s is not in valid range 'shape > 0', for Gamma distribution", params.get(0)));
      } else if (params.get(1) <= 0) {
        throw new CompilerException(
            String.format("%s is not in valid range 'scale > 0', for Gamma distribution", params.get(1)));
      }
    }
  ...
  public static class LogNormal implements Distribution {
    ...
    public static void validate(List<Double> params) throws CompilerException {
      if (params == null || params.size() != 2) {
        ...
        throw new CompilerException(String
            .format("%s is not in valid range 'standardDeviation > 0', for LogNormal distribution", params.get(1)));
      }
    }
  ...
  public static class Pareto implements Distribution {
    ...
    public static void validate(List<Double> params) throws CompilerException {
      if (params == null || params.size() != 2) {
        throw new CompilerException("Expected exactly two parameters (min, shape), for Pareto distribution");
      } else if (params.get(0) <= 0) {
        throw new CompilerException(
            String.format("%s is not in valid range 'min > 0', for Pareto distribution", params.get(0)));
      } else if (params.get(1) <= 0) {
        throw new CompilerException(
            String.format("%s is not in valid range 'shape > 0', for Pareto distribution", params.get(1)));
      }
    }
    ...
    public static void validate(List<Double> params) throws CompilerException {
      if (params == null || params.size() != 2) {
        ...
        throw new CompilerException(String.format(
            "%s is not in valid range 'standardDeviation > 0', for TruncatedNormal distribution", params.get(1)));
      }
    }
  ...
  public static class Uniform implements Distribution {
    ...
    public static void validate(List<Double> params) throws CompilerException {
      if (params == null || params.size() != 2) {
        throw new CompilerException("Expected exactly two parameters (min, max), for Uniform distribution");
      } else if (params.get(0) > params.get(1)) {
        throw new CompilerException(String.format(
            "(%s, %s) does not meet requirement 'min <= max', for Uniform distribution", params.get(0), params.get(1)));
      }
    }
  ...
  private abstract static class Combination implements Distribution {
    public static void validate(List<Double> params) throws CompilerException {
      if (params != null && params.size() != 0) {
        throw new CompilerException(String.format("Expected exactly zero parameters, for combination distributions"));
      }
    }
  }
